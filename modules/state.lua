...
local State = {
    ...
    buffs = {
        ...
        pendingZoneBroadcast = false, -- true after zone-in until BuffsPopulated + justZoned clears
    },

    pet = {
        activeState   = 0,
        assistAt      = 100,   -- PetAssistAt: mob HP% threshold to send pet (set from INI)
        attackRange   = 115,  -- PetAttackDistance default (mac:14810); overwritten by combat.lua init
    ...
    misc = {
        ...
        ammoSwitch           = false,
        autoHide             = false, -- ROG auto-stealth after combat (mac AutoHide)
        dragCorpse           = false,
        banestrike           = '',
        colorIdx             = 0,
        colorList            = 'tWgtuwyr',
