...
-- Returns true when a DPS-slot threshold value routes the slot to the debuff
-- rotation instead of the normal DPS rotation (mac: thresh >= 101 convention).
function Helpers.slotIsDebuff(threshold)
